...
productRouter.get('/', expressAsyncHandler(async (req, res) => {
    ...
    const pageSize = req.query.pageNumber ? 2 : 0;
    ...
    const sortOrder = order === 'lowest' ? { price: 1 } : order === 'newest' ? { price: -1 } : order === 'toprated' ? { rating: -1 } : { _id: -1 }
...
productRouter.get('/catgories/category', expressAsyncHandler(async (req, res) => {
